...
#define DATA_LENGTH (GYRO_DATA_LENGTH + RC5_DATA_LENGTH + MENU_RUN_NUM_MODES + SENSORS_DATA_LENGTH * 3)
...
#define DATA_INDEX_SENSORS_MAX (DATA_INDEX_MENU + MENU_RUN_NUM_MODES)
#define DATA_INDEX_SENSORS_MIN (DATA_INDEX_SENSORS_MAX + SENSORS_DATA_LENGTH)
#define DATA_INDEX_SENSORS_UMB (DATA_INDEX_SENSORS_MIN + SENSORS_DATA_LENGTH)
